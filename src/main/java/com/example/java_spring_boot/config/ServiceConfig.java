...
public class ServiceConfig {
    ...
    public ProductServiceImpl productService(ProductRepository productRepository, UserIdentity userIdentity) {
        System.out.println("product service is created");
        return new ProductServiceImpl(productRepository, userIdentity);
    }
}
